...
def create_dataset_separation_run(data_test: np.array,
    ...
    com_thr = data_test[start + input_timesteps:start + duration, output_shape]

    diff_ele = data_test[start + input_timesteps:start + duration, output_shape + 1]
    sym_ele = data_test[start + input_timesteps:start + duration, output_shape + 2]

    sym_flap = data_test[start + input_timesteps:start + duration, output_shape + 3]

    return initials,com_thr,diff_ele,sym_ele,sym_flap
